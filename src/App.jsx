...
export default function App() {
  ...
  if (isAdmin) {
    return (
      <div className="app-layout">
        <button type="button" onClick={handleLogout} style={styles.btnCerrarSesion}>
          Cerrar Sesión
        </button>
        <ViewAdmin
  ...
  if (vistaLogin) {
    return (
      <div className="app-layout">
        <ViewLogin
          onLoginSuccess={() => setVistaLogin(false)}
          onVolver={() => setVistaLogin(false)}
        />
      </div>
    );
  }
  ...
  return (
    <div className="app-layout">
      <Navbar session={session} onIrALogin={() => setVistaLogin(true)} onLogout={handleLogout} />
      <ViewCliente
        turnosPorFecha={turnosPorFecha}
        setTurnosPorFecha={handleSetTurnos}
